...
// @match        https://*.geo-fs.com/geofs.php*
// @match        https://www.geo-fs.com/geofs.php?v=3.65
// @run-at       document-end
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    window.listLiveries = listLiveries;
    window.sortList = sortList;
    window.loadFavorites = loadFavorites;
    window.star = star;
    window.search = search;
    window.loadLivery = loadLivery;
})();
